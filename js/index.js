...
(function () {
	var data = {
		day365: { orders: '20,301', amount: '998' },
		day90: { orders: '3,019', amount: '94' },
		day30: { orders: '187', amount: '34' },
		day1: { orders: '7', amount: '4' }
	}
	//点击事件
		...
		series: [
			{
				...
				data: [
					...
					{ value: 0, itemStyle: { color: 'transparent' } }// 透明隐藏第三块区域
				]
			}
		]
	};
